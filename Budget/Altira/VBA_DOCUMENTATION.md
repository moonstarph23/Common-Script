# Altira VBA Documentation

**Source workbook:** `Testing/Altira.xlsm`  
**Export folder:** `Budget/Altira/exported_vba`
...
The source project contains 68 VBA components: 7 standard modules, 56 workbook/worksheet class modules, and 5 UserForms. The manual-import export retains all 7 standard modules, the executable `ThisWorkbook` document module, and all 5 UserForms with their binary companions. The 55 empty worksheet modules are omitted. The final export contains 122 procedures and 159 detected direct internal calls.
...
- The 55 empty worksheet class modules are intentionally omitted.
