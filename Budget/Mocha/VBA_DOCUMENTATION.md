# Mocha VBA Documentation

**Source workbook:** `Testing/Mocha.xlsm`  
**Export folder:** `Budget/Mocha/exported_vba`
...
The source project contains 79 VBA components: 7 standard modules, 67 workbook/worksheet class modules, and 5 UserForms. The manual-import export retains all 7 standard modules, the executable `ThisWorkbook` document module, and all 5 UserForms with their binary companions. The 66 empty worksheet modules are omitted. The final export contains 122 procedures and 159 detected direct internal calls.
...
- The 66 empty worksheet class modules are intentionally omitted.
