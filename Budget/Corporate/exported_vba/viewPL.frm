...
Attribute VB_Base = "0{236BD018-7420-41CD-B879-11A56BE811A4}{CA0D1432-7E43-4661-8CBA-9B2FB65D9575}"
...
Private Sub updateButton_Click()
    ...
    If TextBox6.Text = "BY GROUP" Then
        globalMasterSheet.Range("I1").value = "BY GROUP"
    End If
    
    If TextBox6.Text = "SummaryByGroup" Then
        globalMasterSheet.Range("I1").value = "SummaryByGroup"
    End If
