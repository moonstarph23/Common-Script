...
The project contains 59 VBA components: 9 standard modules, 45 workbook/worksheet class modules, and 5 UserForms. Static analysis identified 158 procedures and 139 direct internal call relationships.
...
| `Sheet13.cls` | Workbook/worksheet module | 0 |
...
| `Sheet10.cls` | Workbook/worksheet module | 0 |
| `Sheet7.cls` | Workbook/worksheet module | 0 |
| `Sheet6.cls` | Workbook/worksheet module | 0 |
| `Sheet3.cls` | Workbook/worksheet module | 0 |
| `Sheet2.cls` | Workbook/worksheet module | 0 |
...
| `Sheet15.cls` | Workbook/worksheet module | 0 |
...
| `Sheet12.cls` | Workbook/worksheet module | 0 |
...
| `Sheet22.cls` | Workbook/worksheet module | 0 |
| `Module1.bas` | Standard module | 2 |
| `Sheet23.cls` | Workbook/worksheet module | 0 |
| `Module2.bas` | Standard module | 6 |
| `Sheet24.cls` | Workbook/worksheet module | 0 |
| `Sheet29.cls` | Workbook/worksheet module | 0 |
| `Sheet30.cls` | Workbook/worksheet module | 0 |
| `Sheet16.cls` | Workbook/worksheet module | 0 |
| `Sheet25.cls` | Workbook/worksheet module | 0 |
| `Sheet26.cls` | Workbook/worksheet module | 0 |
| `Sheet27.cls` | Workbook/worksheet module | 0 |
