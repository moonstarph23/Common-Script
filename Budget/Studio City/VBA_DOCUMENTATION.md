# Studio City VBA Documentation

**Source workbook:** `Testing/Studio City.xlsm`  
**Export folder:** `Budget/Studio City/exported_vba`
...
The source project contains 58 VBA components: 8 standard modules, 45 workbook/worksheet class modules, and 5 UserForms. The manual-import export retains all 8 standard modules, the executable `ThisWorkbook` document module, and all 5 UserForms with their binary companions. The 44 empty worksheet modules are omitted. The final export contains 123 procedures and 159 detected direct internal calls.
...
- The 44 empty worksheet class modules are intentionally omitted.
