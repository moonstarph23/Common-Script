# Sri Lanka - Casino VBA Documentation

**Source workbook:** `Testing/Sri Lanka - Casino.xlsm`  
**Export folder:** `Budget/Sri Lanka - Casino/exported_vba`
...
The source project contains 61 VBA components: 7 standard modules, 49 workbook/worksheet class modules, and 5 UserForms. The manual-import export retains all 7 standard modules, the executable `ThisWorkbook` document module, and all 5 UserForms with their binary companions. The 48 empty worksheet modules are omitted. The final export contains 122 procedures and 159 detected direct internal calls.
...
flowchart TD
    ...
    More["59 additional calls listed below"]
```
...
| `updateBudgetFY.bas` | Standard module | 9 |
...
- The 48 empty worksheet class modules are intentionally omitted.
